        ...
        <div class="formgroup">
            ...
            <div class="especialidades">
                ...
                <div class="especialidades-group">
                    <div class="check-group">
                        <input type="checkbox" name="specialties[]" id="" value="MEDICINA">
                    ...
                    <div class="check-group">
                        <input type="checkbox" name="specialties[]" id="" value="FONOAUDIOLOGIA">
            ...
            <div class="equipamentos">
                ...
                <div class="equipamentos-group">
                    <div class="check-group">
                        <input type="checkbox" name="equipaments[]" id="" value="ECOCARDIOGRAMA">
