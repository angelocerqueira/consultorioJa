...
<body>
            ...
            <div class="container">
                ...
                <div class="menu">
                    <ul>
                        ...
                        <li><a href="/cadastroconsultorio">cadastre seu espaço</a></li>
                        <li><a href="/faleconosco">fale conosco</a></li>
                    </ul>

                    <div class="busca">
                        <form action="">
                            <input type="search" name="" id="" placeholder="Busque pela sua localizacao">
                            <input type="submit">
                        </form>
                    </div>
                </div>
    ...
    <script src="js/scrollReaveal.js"></script>
